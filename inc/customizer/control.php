...
class superultra_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="superultra-chosen-select" <?php $this->link(); ?>>
                    <?php
...
Class superultra_Customize_Horizontal_Line extends WP_Customize_Control {
    public $type = 'hr';
...
class superultra_Multi_Input_Custom_Control extends WP_Customize_Control {
    /**
     * Control type
     *
     * @var string
...
class superultra_Note_Control extends WP_Customize_Control {
