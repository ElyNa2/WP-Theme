...
( function( $, api ) {
	...
	api.controlConstructor['superultra-repeater-text'] = api.Control.extend({
	    ...
	    // upsell 
    api.sectionConstructor['superultra-upsell'] = api.Section.extend( {
...
*/
 jQuery(document).ready(function($) {
    // $('#superultra-img-container li label img').click(function(){    	
    //     $('#superultra-img-container li').each(function(){
    //         $(this).find('img').removeClass ('superultra-radio-img-selected') ;
    //     });
    //     $(this).addClass ('superultra-radio-img-selected') ;
    // }); 
    ...
    $( document ).on( 'click', '.customize_multi_add_field', superultra_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', superultra_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', superultra_customize_multi_remove_field )
    ...
    $('#customize-control-theme_options-layout_options_blog #superultra-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_blog #superultra-img-container li').each(function(){
            $(this).find('img').removeClass ('superultra-radio-img-selected') ;
        });
        $(this).addClass ('superultra-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_archive #superultra-img-container li label img').click(function(){       
        $('#customize-control-theme_options-layout_options_archive #superultra-img-container li').each(function(){
            $(this).find('img').removeClass ('superultra-radio-img-selected') ;
        });
        $(this).addClass ('superultra-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_page #superultra-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_page #superultra-img-container li').each(function(){
            $(this).find('img').removeClass ('superultra-radio-img-selected') ;
        });
        $(this).addClass ('superultra-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_single #superultra-img-container li label img').click(function(){        
        $('#customize-control-theme_options-layout_options_single #superultra-img-container li').each(function(){
            $(this).find('img').removeClass ('superultra-radio-img-selected') ;
        });
        $(this).addClass ('superultra-radio-img-selected') ;
    });    

    function superultra_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            superultra_customize_multi_write( $control );
    }

    function superultra_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        superultra_customize_multi_write( $control );
    }

    function superultra_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function superultra_customize_multi_write( $element) {
